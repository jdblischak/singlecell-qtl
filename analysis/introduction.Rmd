...
While a large number of studies have focused on the robustness of particular cellular functions or individual genes in humans [@Wills2013;@Shaffer2014;@Halpern2015;@Hendy2017], genome-wide analysis and mapping of the genetic loci underlying robustness has yet to be performed.
...
Nevertheless, the lack of an iPSC system for single cell studies of robustness has hindered the investigation of regulatory noise during differentiation and development in humans.
