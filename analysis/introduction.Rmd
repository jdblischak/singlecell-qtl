...
The importance of robustness and the regulation of noise as mechanisms that maintain high evolutionary fitness is evident[@Kirschner1998;@Kitano2004;@Masel2009].
...
With few exceptions [@Deng2014;@Marinov2014], experimental evolution studies have always considered population-average measurements of phenotypes using entire organisms, tissues, or cell cultures.
However, as was often suggested in the literature, to truly understand how robustness is established and encoded in the genome, one needs to consider variation in phenotypes across individual cells[@Raser2004;@Kaern2005;@Balazsi2011].
...
While a large number of studies have focused on the robustness of particular cellular functions or individual genes in humans [@Wills2013;@Shaffer2014], genome-wide analysis and mapping of the genetic loci underlying robustness has yet to be performed.
...
As a result, research is also aimed at understanding how expression noise is controlled and interpreted within gene regulatory networks [@Eldar2010].
...
Furthermore, the lack of an iPSC system for single cell studies of robustness has hindered the investigation of regulatory noise during differentiation and development in humans.
...
To do so, we applied a QTL approach to map inter-individual variation in regulatory noise in a panel of iPSCs reprogrammed from deeply characterized Yoruba HapMap lymphoblastoid cell lines (LCLs)[@Banovich2018]. 
