...
** Simulation
   ...
   #+BEGIN_SRC ipython :ipyfile figure/zinb.org/sim1.png
     ...
     subset = result.loc[np.logical_and.reduce(np.vstack([sample_pass, pi_pass])),['log_mu', 'log_mu_hat']]
     ...
     subset = result.loc[sample_pass,['logodds', 'logodds_hat']]
