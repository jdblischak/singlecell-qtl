...
* Evaluating goodness of fit
  ...
  #+BEGIN_SRC ipython
    X, design = simulate(num_samples=5000, size=1e5, log_mu=-12, log_phi=-.5, logodds=0, seed=0, design=None, fold=None)
  ...
  :RESULTS:
  # Out[104]:
  : [<matplotlib.lines.Line2D at 0x7eff8c5d4710>]
  ...
  #+BEGIN_SRC ipython :ipyfile figure/zinb.org/endov.png
    ...
    pmf = []
    for value in np.arange(data.loc[k].max()):
