...
* numpy/scipy implementation
  ...
  #+BEGIN_SRC ipython
    ...
    def evaluate(num_samples, num_mols, log_mu, log_phi, logodds, trial):
      ...
      result = _fit_gene(simulate(num_samples=num_samples, size=num_mols,
                                  log_mu=log_mu, log_phi=log_phi,
                                  logodds=logodds, seed=trial))
      result = [num_samples, num_mols, log_mu, log_phi, logodds, trial] + list(result)
