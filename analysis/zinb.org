...
* numpy/scipy implementation
  ...
  #+BEGIN_SRC ipython
    ...
    def evaluate(num_samples, num_mols, log_mu, log_phi, logodds, fold, trial):
      ...
      result = [num_samples, num_mols, log_mu, log_phi, logodds, trial, fold] + list(_fit_gene(x, onehot, design))
  ...
  # Out[263]:
  #+BEGIN_EXAMPLE
    [array([-7.75374851, -8.74604202]),
    array([-6.72224875, -6.76463141]),
    array([-3.08324086, -3.07316665]),
    array([42.9130922, 15.9089754]),
    array([45.12998187, 16.20101539])]
  #+END_EXAMPLE
  :END:
  ...
  #+BEGIN_SRC ipython
    evaluate(num_samples=1000, num_mols=1e5, log_mu=-8, log_phi=-6, logodds=-3, fold=1.1, trial=0)
  #+END_SRC
  ...
  #+BEGIN_EXAMPLE
    {'fold': 1.1,
    'log_mu': -8,
    'log_mu_hat': array([-8.00785373]),
    'log_phi': -6,
    'log_phi_hat': array([-5.52468537]),
    'logodds': -3,
    'logodds_hat': array([-2.88298067]),
    'mean': array([33.28383137]),
    'mean_log_cpm': 5.635841618437168,
    'num_mols': 100000.0,
    'num_samples': 1000,
    'trial': 0,
    'var': array([37.70081974]),
    'var_log_cpm': 0.6708102759540933}
  #+END_EXAMPLE
  :END:
