...
We identify the lower cutoff using the mean log2 molecule counts per million (cpm) in the high quality single cells. r length(genes_pass_filter) genes have a mean log2 molecule cpm greater than r lower_exp_cutoff
...
write.table(data.frame(row.names(mol_hs_cpm), mol_hs_cpm[,"filter"]),
            file = "../data/genes_pass_filter.txt", quote = FALSE,
