...
set.seed(1106)
pwpca_eset <- pagoda.pathway.wPCA(varinfo_eset_sub, go.env, n.components=1, n.cores=1, n.internal.shuffles=50)
...
```{r depth-control}
pwpca_eset_dep <- pagoda.pathway.wPCA(varinfo_dep, go.env, n.components=1, n.cores=1, n.internal.shuffles=50)
