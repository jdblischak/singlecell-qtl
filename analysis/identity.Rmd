...
Colored by individual. The most worrisome are the last three C1 chips (04132017,
04142017, 04202017), which all have high numbers of assignments coming from one
or more individuals that were not on that chip.

```{r ind-per-chip-color}
