...
* QTL discovery
  ...
  #+BEGIN_EXAMPLE
    ...
    7          1000    114026     -12  0.968472
    8          1000    114026     -11  0.979160
    9          1000    114026     -10  0.991243
    10         1000    114026      -9  0.994651
    11         1000    114026      -8  0.997622
    12         1000    114026      -7  0.999581
    13         1000    114026      -6  0.999661
    14        10000    114026     -12  0.970102
    15        10000    114026     -11  0.980160
    16        10000    114026     -10  0.992239
    17        10000    114026      -9  0.995632
    18        10000    114026      -8  0.998242
    19        10000    114026      -7  0.999954
    20        10000    114026      -6  0.999969
  #+END_EXAMPLE
  :END:
...
* Distribution of effect sizes.
  ...
  #+RESULTS:
  : Submitted batch job 46548862

  Read the summary statistics.

  #+BEGIN_SRC ipython
    stats = {x: pd.read_table('/scratch/midway2/aksarkar/singlecell/power/{}.txt.gz'.format(x), index_col=[0, 2])
             for x in ('log_mu', 'variance', 'fano', 'cv')}
  #+END_SRC
  ...
  #+BEGIN_SRC ipython
    betahat = pd.DataFrame({k: v['beta'] for k, v in stats.items()})
    betahat = (betahat
               .groupby(level=1)
               .apply(downsample, n=10))
    se = pd.DataFrame({k: v['se'] for k, v in stats.items()})
    # betahat, se = betahat.align(se, axis='index', join='inner')
  #+END_SRC
  ...
  Serialize the ~mash~ result.

  #+BEGIN_SRC ipython
     with open('/scratch/midway2/aksarkar/singlecell/power/mash-result.pkl', 'wb') as f:
  ...
  #+BEGIN_SRC ipython
     with open('/scratch/midway2/aksarkar/singlecell/power/mash-result.pkl', 'rb') as f:
  ...
  #+BEGIN_SRC ipython
    pd.Series({k: v for k, v in
               zip(['pointmass'] + list(U.names),
...
* Distribution of PVE
  ...
  *Bayesian argument.* 
  ...
  #+BEGIN_SRC ipython
    (estimated_pve['Abundance'] / estimated_pve['Bulk']).describe()  
  #+END_SRC
  ...
  #+BEGIN_SRC ipython :ipyfile figure/power.org/effective-pve.png
    ...
    f2 = st.gaussian_kde(estimated_pve['Abundance'].dropna())
  ...
  Estimate the same for mean PVE
