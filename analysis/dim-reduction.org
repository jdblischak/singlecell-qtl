...
* Introduction
  ...
  5. [[*Effect of centering on PCA][We show that after adjusting for both sample- and gene-specific means]] the
     top PC is less correlated with gene detection rate, and is likely
     explained simply by higher order variation between samples
