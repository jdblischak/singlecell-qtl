...
* Principal components analysis
  ...
  #+BEGIN_SRC ipython :exports none
    %matplotlib agg
    plot_pca_covar_corr(ppca, corr)
    plt.savefig('/project2/mstephens/aksarkar/projects/singlecell-qtl/analysis/figure/dim-reduction.org/pca-vs-covars-hires.png', dpi=300)
    %matplotlib inline
  #+END_SRC
  ...
  #+BEGIN_SRC ipython
    def plot_quantiles_vs_detection(umi, annotations, quantiles=None, pseudocount=None):
      ...
      for q, v in zip(quantiles, vals):
        plt.scatter(annotations['detect_hs'] / umi.shape[0], v, c=colorcet.cm['inferno'](q), label='{:.3f}'.format(q), s=2)
...
* PCA on bicentered data
  ...
  #+BEGIN_SRC ipython :exports none
    %matplotlib agg
    plot_bicentered_pca(log_cpm, annotations, cont_covars, cat_covars)
    plt.savefig('/project2/mstephens/aksarkar/projects/singlecell-qtl/analysis/figure/dim-reduction.org/pca-bicentered-covars-hires.png', dpi=300)
    %matplotlib inline
  #+END_SRC
...
* Kernel PCA
  ...
  #+BEGIN_SRC ipython :noweb yes :exports none
    %matplotlib agg
    <<plot-kpca-covars>>
    plt.savefig('/project2/mstephens/aksarkar/projects/singlecell-qtl/analysis/figure/dim-reduction.org/kpca-covars-hires.png', dpi=300)
    %matplotlib inline
  #+END_SRC
...
* PCA on gene expression residuals
  ...
  #+BEGIN_SRC ipython :exports none
    %matplotlib agg
    plot_bicentered_pca(log_cpm_residuals, annotations, cont_covars, cat_covars)
    plt.savefig('/project2/mstephens/aksarkar/projects/singlecell-qtl/analysis/figure/dim-reduction.org/pca-expr-residual-covars-hires.png', dpi=300)
    %matplotlib inline
  #+END_SRC
