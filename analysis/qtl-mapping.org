...
* Introduction
  ...
  3. We call QTLs using [[*Analysis using counts][counts]] and [[*Analysis using log CPM][log CPM]]
  4. We [[*Explain away variance QTLs][explain away variance QTLs]]
  5. [[*QTL overlap][We test replication/overlap]] between different QTL calls
...
* Implementation
  ...
  #+NAME: tabix
  #+BEGIN_SRC sh :var input="test.bed" :var partition="broadwl" :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping :eval never-export
    export input=$input
  ...
  #+NAME: qtltools
  #+BEGIN_SRC sh :var pheno="test" :var geno="geuvadis-chr1.vcf.gz" :var partition="broadwl" :var op="--permute 100000" :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping :eval never-export :results output
    export pheno=$pheno
    export geno=$geno
    export op=$op
...
** Call eQTLs from pooled scRNA-Seq
   ...
   #+CALL: tabix(input="pooled.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+CALL: qtltools(pheno="pooled", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov pooled-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/pooled-beta-approx.png
   ...
   :RESULTS:
   # Out[61]:
   [[file:figure/qtl-mapping.org/counts/pooled-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/pooled-qtl-qq.png
     qqplot(pooled_qtls)
   #+END_SRC
   ...
   :RESULTS:
   # Out[62]:
   [[file:figure/qtl-mapping.org/counts/pooled-qtl-qq.png]]
   :END:
...
** Call mean-QTLs
   ...
   #+CALL: tabix(input="sample-mean.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+CALL: qtltools(pheno="sample-mean", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov sample-mean-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/sample-mean-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[73]:
   [[file:figure/qtl-mapping.org/counts/sample-mean-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/sample-mean-qtl-qq.png
   ...
   :RESULTS:
   # Out[74]:
   [[file:figure/qtl-mapping.org/counts/sample-mean-qtl-qq.png]]
   :END:
...
** Call variance-QTLs
   ...
   #+CALL: tabix(input="sample-var.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+CALL: qtltools(pheno="sample-var", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov sample-var-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/sample-var-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[80]:
   [[file:figure/qtl-mapping.org/counts/sample-var-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/sample-var-qtl-qq.png
   ...
   :RESULTS:
   # Out[81]:
   [[file:figure/qtl-mapping.org/counts/sample-var-qtl-qq.png]]
   :END:
...
** Call CV-QTLs
   ...
   #+CALL: tabix(input="sample-cv.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+CALL: qtltools(pheno="sample-cv", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/sample-cv-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[86]:
   [[file:figure/qtl-mapping.org/counts/sample-cv-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/sample-cv-qtl-qq.png
   ...
   :RESULTS:
   # Out[87]:
   [[file:figure/qtl-mapping.org/counts/sample-cv-qtl-qq.png]]
   :END:
...
** Call Fano-QTLs
   ...
   #+CALL: tabix(input="sample_fano.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+CALL: qtltools(pheno="sample_fano", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov sample-fano-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/counts
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/sample-fano-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[98]:
   [[file:figure/qtl-mapping.org/counts/sample-fano-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/sample-fano-qtl-qq.png
   ...
   :RESULTS:
   # Out[99]:
   [[file:figure/qtl-mapping.org/counts/sample-fano-qtl-qq.png]]
   :END:
...
** Call eQTLs from pooled scRNA-Seq
   ...
   #+CALL: tabix(input="pooled.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
   ...
   #+CALL: qtltools(pheno="pooled", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov pooled-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
...
** Call mean-QTLs
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/counts/num-individuals-pass.png
     plt.clf()
   ...
   :RESULTS:
   # Out[27]:
   [[file:figure/qtl-mapping.org/counts/num-individuals-pass.png]]
   :END:
   ...
   #+CALL: tabix(input="sample-mean.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
   ...
   #+CALL: qtltools(pheno="sample-mean", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov sample-mean-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
...
** Call variance-QTLs
   ...
   #+CALL: tabix(input="sample-var.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
   ...
   #+CALL: qtltools(pheno="sample-var", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov sample-var-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
...
** Call CV-QTLs
   ...
   #+CALL: tabix(input="sample-cv.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
   ...
   #+CALL: qtltools(pheno="sample-cv", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
...
** Call Fano-QTLs
   ...
   #+CALL: tabix(input="sample_fano.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
   ...
   #+CALL: qtltools(pheno="sample_fano", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov sample-fano-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/log-cpm
...
** Call eQTLs
   ...
   #+CALL: tabix(input="mean.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+CALL: qtltools(pheno="mean", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov mean-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/mean-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[109]:
   [[file:figure/qtl-mapping.org/zinb/mean-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/mean-qtl-qq.png
     qqplot(mean_qtls)
   #+END_SRC
   ...
   :RESULTS:
   # Out[110]:
   [[file:figure/qtl-mapping.org/zinb/mean-qtl-qq.png]]
   :END:
...
** Fit multiplicative model
   ...
   #+CALL: tabix(input="multmean.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+CALL: qtltools(pheno="multmean", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov multmean-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/multmean-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[116]:
   [[file:figure/qtl-mapping.org/zinb/multmean-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/multmean-qtl-qq.png
   ...
   :RESULTS:
   # Out[117]:
   [[file:figure/qtl-mapping.org/zinb/multmean-qtl-qq.png]]
   :END:
...
** Call \phi-QTLs
   ...
   #+CALL: tabix(input="log_phi.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+CALL: qtltools(pheno="log_phi", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/phi-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[122]:
   [[file:figure/qtl-mapping.org/zinb/phi-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/phi-qtl-qq.png
    qqplot(log_phi_qtls)
   #+END_SRC
   ...
   :RESULTS:
   # Out[123]:
   [[file:figure/qtl-mapping.org/zinb/phi-qtl-qq.png]]
   :END:
...
** Call variance-QTLs
   ...
   #+CALL: tabix(input="variance.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+CALL: qtltools(pheno="variance", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov variance-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/variance-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[130]:
   [[file:figure/qtl-mapping.org/zinb/variance-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/variance-qtl-qq.png
   ...
   :RESULTS:
   # Out[131]:
   [[file:figure/qtl-mapping.org/zinb/variance-qtl-qq.png]]
   :END:
...
** Call CV-QTLs
   ...
   #+CALL: tabix(input="cv.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+CALL: qtltools(pheno="cv", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/cv-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[137]:
   [[file:figure/qtl-mapping.org/zinb/cv-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/cv-qtl-qq.png
     qqplot(cv_qtls)
   #+END_SRC
   ...
   :RESULTS:
   # Out[138]:
   [[file:figure/qtl-mapping.org/zinb/cv-qtl-qq.png]]
   :END:
...
** Call Fano-QTLs
   ...
   #+CALL: tabix(input="fano.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+CALL: qtltools(pheno="fano", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/fano-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[144]:
   [[file:figure/qtl-mapping.org/zinb/fano-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/fano-qtl-qq.png
     qqplot(fano_qtls)
   #+END_SRC
   ...
   :RESULTS:
   # Out[145]:
   [[file:figure/qtl-mapping.org/zinb/fano-qtl-qq.png]]
   :END:
...
** Call variance-QTLs
   ...
   #+CALL: tabix(input="resid.bed") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+CALL: qtltools(pheno="resid", geno="/scratch/midway2/aksarkar/singlecell/scqtl-mapping/yri-120-dosages.vcf.gz", op="--cov resid-covars.txt --window 100000 --permute 10000") :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping/zinb
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/resid-qtl-beta-approx.png
   ...
   :RESULTS:
   # Out[153]:
   [[file:figure/qtl-mapping.org/zinb/resid-qtl-beta-approx.png]]
   :END:

   Plot a QQ plot of the adjusted p-values.

   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/zinb/resid-qtl-qq.png
     qqplot(resid_qtls)
   #+END_SRC
   ...
   :RESULTS:
   # Out[154]:
   [[file:figure/qtl-mapping.org/zinb/resid-qtl-qq.png]]
   :END:
...
* Write out the QTLs
  ...
  #+BEGIN_SRC sh :dir /scratch/midway2/aksarkar/singlecell/scqtl-mapping
    ...
    export -f z
    parallel -j1 z ::: cv fano mean log_phi multmean variance resid cv_resid
    rsync -FFau . /project2/mstephens/aksarkar/projects/singlecell-qtl/data/scqtl-mapping/
  #+END_SRC

  #+RESULTS:
  : Submitted batch job 49699529
