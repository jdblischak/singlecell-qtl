   ...
   #+BEGIN_SRC ipython
     with sqlite3.connect('/project2/mstephens/aksarkar/projects/singlecell-qtl/browser/browser.db') as conn:
       (qtls
        ...
        .reset_index()
        [['gene', 'name', 'id', 'p_beta', 'beta', 'log_mean_resid_var', 'log_mean_error_var', 'log_phi_resid_var', 'log_phi_error_var']]
        .to_sql('mean_qtls', conn, index=False, if_exists='replace'))
       conn.execute('create index ix_mean_qtls on mean_qtls("gene");')
