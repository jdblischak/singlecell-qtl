...
** Explain away variance-QTLs
   ...
   Regress out the (standardized) mean from the (standardized) variance. 

   This is a set of independent univariate regressions which can be done in
   parallel.
