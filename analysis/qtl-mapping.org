...
** Replication rates
  ...
  #+BEGIN_EXAMPLE
    ...
    Mean       100      99.3  4.3  91.8
    Variance  99.3       100 9.46   100
    CV           0      3.45  100   6.9
    Fano      96.3       100 14.8   100
  #+END_EXAMPLE
  :END:

  Extract the CV QTLs for the browser.
...
** Relationship of \(p\)-values, effect sizes, and expression levels
   ...
   #+BEGIN_SRC ipython :ipyfile figure/qtl-mapping.org/pooled-qtl-vs-mean-qtl.png
     lim = [-12, 12]
     plt.clf()
     plt.gcf().set_size_inches(6, 6)
     plt.plot(lim, lim, c='r', ls=':', lw=1)
     ...
     plt.xlim(lim)
     plt.ylim(lim)
     plt.xlabel('Pooled single cell eQTL $z$-score')
   ...
   :RESULTS:
   # Out[130]:
   [[file:figure/qtl-mapping.org/pooled-qtl-vs-mean-qtl.png]]
   :END:
