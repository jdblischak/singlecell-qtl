...
** Replication rates
   ...
   #+BEGIN_SRC ipython
     ...
     qtls = {pheno: [pd.read_table('{}/{}.txt.gz'.format(prefix, pheno), sep=' '),
             ...
             for pheno in ['bulk', 'mean', 'variance', 'cv', 'fano']}
   #+END_SRC
