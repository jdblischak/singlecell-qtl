...
* Test environment
  ...
  #+RESULTS:
  : 
  : srun: job 46261035 queued and waiting for resources
  : srun: job 46261035 has been allocated resources
  : cd /project2/mstephens/aksarkar/projects/singlecell-qtl/browser/
  ...
  : bokeh serve fano-qtls simulation poisson-beta --address $(hostname -i) --allow-w ebsocket-origin=$(hostname -i):5006 &
  : [7] 13580
  : echo "http://$(hostname -i):5006"
  : echo 'org_babel_sh_eoe'
  : http://10.50.221.90:5006
